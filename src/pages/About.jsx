...
const About = () => {
  ...
  const milestones = [
    ...
    { year: '2023', title: 'Tally Cloud', desc: 'Expanded support to Tally Cloud infrastructure & custom TDL deployments.' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 pt-24 pb-20 font-system">
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        >
          <span className="inline-block px-4 py-1.5 rounded-full bg-tally-teal/10 text-tally-teal text-xs font-medium mb-4 uppercase tracking-wider">
            ABOUT ABS TECHNOLOGY
          </span>

          <h1 className="text-4xl md:text-5xl font-semibold leading-tight mb-6 text-tally-blue">
            Building Smarter Businesses with{' '}
            <span className="text-tally-teal">Tally Solutions</span>
          </h1>

          <p className="text-gray-600 text-lg leading-relaxed">
            We are experts in Tally implementation, custom TDL developments, and 
            seamless API integrations — enabling businesses to modernize their 
            accounting and operations efficiently.
          </p>
        </motion.div>

        {/* HERO IMAGE */}
        <motion.div
          className="rounded-3xl shadow-xl mb-20 bg-gray-100 flex items-center justify-center min-h-[400px]"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
          {companyStats.map(({ num, label, icon: Icon }, i) => (
            ...
            >
              <Icon className="w-6 h-6 text-tally-teal mx-auto mb-3" />
              <p className="text-3xl font-bold text-tally-blue">{num}</p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20">
          ...
          <div className="p-8 rounded-3xl bg-white shadow-md border">
            <Target className="text-tally-blue mb-4" />
            <h3 className="text-xl font-semibold mb-3 text-tally-blue">Our Mission</h3>
          ...
          <div className="p-8 rounded-3xl bg-white shadow-md border">
            <Eye className="text-tally-teal mb-4" />
            <h3 className="text-xl font-semibold mb-3 text-tally-blue">Our Vision</h3>
            <p className="text-gray-600">
              To become India's most trusted Tally solutions partner,
              enabling connected accounting ecosystems across businesses.
            </p>
          </div>
        ...
        {/* JOURNEY */}
        <div className="mb-20">
          <h2 className="text-3xl font-semibold text-center mb-10 text-tally-blue">Our Journey</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {milestones.map((m) => (
              ...
              >
                <span className="text-tally-yellow font-bold text-2xl">{m.year}</span>
                <h4 className="font-semibold mt-2 text-tally-blue">{m.title}</h4>
        ...
        {/* VALUES */}
        <div className="mb-20">
          <h2 className="text-3xl font-semibold text-center mb-10 text-tally-blue">Our Values</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={title} className="p-6 rounded-2xl bg-white border shadow-sm">
                <Icon className="text-tally-teal mb-3" />
                <h4 className="font-semibold text-tally-blue">{title}</h4>
        ...
        {/* INDUSTRIES */}
        <div className="bg-tally-blue rounded-3xl p-10 mb-20 text-white">
          ...
          <div className="grid md:grid-cols-4 gap-3">
            {[
              ...
              <div key={i} className="bg-white/10 px-4 py-3 rounded-xl text-sm hover:bg-tally-teal/20 transition">
                {i}
              </div>
            ))}
          </div>
        ...
        <div className="text-center">
          ...
          <h2 className="text-2xl font-semibold mb-3 text-tally-blue">
          ...
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 bg-tally-blue text-white px-8 py-4 rounded-full hover:bg-[#1a4a75] transition"
          >
            Contact Sales
