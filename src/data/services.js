...
export const services = [
  {
    ...
    desc: "Authorized TallyPrime licensing with expert setup, GST compliance, multi-location deployment, and full ERP customization for businesses of every size. From single-user licenses to multi-branch enterprise rollouts, we handle installation, data migration, and user training end-to-end — so your team goes live with zero disruption and maximum efficiency from day one.",
    icon: CheckCircle,
  ...
  },
  {
    ...
    desc: "Connect TallyPrime with eCommerce platforms, CRMs, payment gateways, and custom applications through robust API integrations and real-time data sync. We eliminate manual data entry, reduce errors, and keep every system — from Shopify to Salesforce — perfectly in sync with your Tally books, so your finance team always works with a single source of truth.",
    icon: Link2,
    iconColor: "text-brand-red",
    iconBg: "bg-brand-red/5",
  ...
  },
  {
    ...
    desc: "Tailored TDL scripts, TallyPrime Solution Boosters, and powerful add-on modules to extend Tally far beyond its default capabilities. Whether you need custom invoice formats, barcode printing, advanced approval workflows, or industry-specific reports, our expert TDL developers build secure, update-proof solutions that fit your exact business processes.",
    icon: Code,
    iconColor: "text-brand-red",
    iconBg: "bg-brand-red/5",
  ...
  },
  {
    ...
    desc: "Comprehensive AMC coverage with TSS renewals, 24/7 remote support, onsite visits, data repair, and hands-on training for your entire team. Our certified engineers handle version upgrades, performance tuning, and emergency recovery — so you never lose a single hour of productivity to a Tally issue, and your business stays always-on, always-compliant.",
    icon: Wrench,
    iconColor: "text-brand-red",
    iconBg: "bg-brand-red/5",
  ...
  },
  {
    ...
    desc: "Run TallyPrime on secure AWS/Azure cloud infrastructure with automated backups, cross-platform access, and 99.9% uptime SLA — access your data from anywhere. Enjoy enterprise-grade security with 256-bit encryption, dedicated instances, and disaster recovery — so your team can work seamlessly from any device, any location, without worrying about hardware failures or data loss.",
    icon: Server,
    iconColor: "text-brand-red",
    iconBg: "bg-brand-red/5",
    image: cloudImg,
  ...
  },
  {
    ...
    desc: "Custom mobile applications with real-time Tally data sync for field sales automation, inventory checking, director dashboards, and on-the-go approvals. Empower your field teams with offline-first apps that work anywhere, GPS-tracked beat routing, instant order booking, and live MIS dashboards — putting your entire business in the palm of your hand, 24/7.",
    icon: Smartphone,
    iconColor: "text-brand-red",
    iconBg: "bg-brand-red/5",
    image: mobileImg,
